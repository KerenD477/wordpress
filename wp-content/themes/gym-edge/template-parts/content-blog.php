...
{
	$gymnaz_blog_title 	= get_theme_mod( 'gymnaz_blog_title', esc_html__( 'Our News & Blogs','gym-edge'));
	$gymnaz_blog_subtitle 	= get_theme_mod( 'gymnaz_blog_subtitle', esc_html__( 'Latest News','gym-edge') );
	$gymnaz_rm_button_label 	= get_theme_mod( 'gymnaz_rm_button_label', esc_html__( 'Read More','gym-edge'));
                    ...
                    <article class="blog-item">
                      ...
                      <div class="post-inner">
                        ...
                        <div class="entry-meta">
                          ...
                          <span class="comment-num"><?php _e(' / ','gym-edge'); ?><?php comments_number(); ?></span>
